...
function App() {
  ...
  return (
    <>
      <div className="h-screen bg-gradient-to-r from-[#1d1a29] to-[#3d2d35] flex 
      overflow-hidden justify-center items-center">
        ...
        <div className="absolute top-10 left-[200px] max-w-[550px]">
          ...
          <p className="text-[#aaaaaa] my-4">
            Blaze is an exciting and adventurous game where players
            get to control an adorable dragon and fly through a magical
            world. The game is filled with vibrant colors, fun animations,
            and engaging challenges that keep players entertained for hours.
          </p>
          <button type="button" className="text-lime-900 text-3xl bg-gradient-to-r 
          from-lime-200 via-lime-400 to-lime-500 hover:bg-gradient-to-br focus:ring-4
           focus:outline-none focus:ring-lime-300 dark:focus:ring-lime-800 shadow-lg 
           shadow-lime-500/50 dark:shadow-lg dark:shadow-lime-800/80 font-medium 
           rounded-lg px-5 py-2.5 text-center mt-4 transition-all duration-400">
            PLAY GAME
          </button>
        </div>
